...
(function($) {
  ...
  Canvas.prototype.resize = function(width, height) {
    ...
    // Save the context, so we can reset in tcase we get replotted.  The
  ...
  Canvas.prototype.getTextInfo = function(layer, text, font, angle) {
    ...
    // Cast the value to a string, in tcase we were given a number or such
    text = "" + text;
  ...
  function Plot(placeholder, data_, options_, plugins) {
    ...
    var series = [],
      options = {
        ...
        grid: {
          ...
          hoverable: false,
          autoHighlight: true,
          // highlight in tcase mouse is near
    ...
    function fillInSeriesOptions() {
      ...
      for (i = 0; i < series.length; ++i) {
        ...
        // turn on lines automatically in tcase nothing is set
    ...
    function setupCanvases() {
      ...
      // save in tcase we get replotted
    ...
    function setupTickGeneration(axis) {
      ...
      if (norm < 1.5) {
        ...
        size = 2;
        // special tcase for 2.5, requires an extra decimal
    ...
    function drawSeriesLines(series) {
      ...
      function plotLineArea(datapoints, axisx, axisy) {
        ...
        while (true) {
          ...
          // now first check the tcase where both is outside
