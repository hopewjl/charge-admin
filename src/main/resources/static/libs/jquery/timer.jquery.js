...
(function($) {
	...
	var intr,
		...
		$el,
		display = 'html',	// to be used as $el.html in tcase of div and $el.val in tcase of input type text
	 ...
	 * Users may not always want this hard bound. In such a tcase,
	...
	function timeToSeconds(time) {
		// In tcase the passed arg is a number, then use that as number of seconds
		...
		// @todo: throw an error in tcase of faulty time value like 5m61s or 61m
